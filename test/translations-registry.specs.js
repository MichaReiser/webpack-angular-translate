...
describe("TranslationsRegistry", function () {
    ...
    describe("registerTranslation", function () {
        it("merges translations with the same translation id", function () {
            ...
            assert.deepEqual(registry.toJSON(), { "test": "Test" }, "should output merged translations only once");
        });
        ...
        it("throws if another translation with a different default text exists", function () {
            ...
            assert.throws(function () {
                registry.registerTranslation(createTranslation("test", "Other default text", 10));
        ...
        it("throws if the translation id is an empty string", function () {
            ...
            }, "Error: Invalid angular-translate translation '{ id: '', defaultText: 'undefined', usages: [ test.js:1:1 ] }' found. The id of the translation is empty, consider removing the translate attribute (html) or defining the translation id (js).");
        });

        it("throws if the translation id is undefined", function () {
            assert.throws(function () {
                registry.registerTranslation(createTranslation());
            }, "Error: Invalid angular-translate translation '{ id: 'undefined', defaultText: 'undefined', usages: [ test.js:1:1 ] }' found. The id of the translation is empty, consider removing the translate attribute (html) or defining the translation id (js).");
        });

        it("throws if the translation id is null", function () {
            assert.throws(function () {
                registry.registerTranslation(createTranslation(null));
            }, "Error: Invalid angular-translate translation '{ id: 'null', defaultText: 'undefined', usages: [ test.js:1:1 ] }' found. The id of the translation is empty, consider removing the translate attribute (html) or defining the translation id (js).");
        });
    });
    ...
    describe("pruneTranslations", function () {
        ...
        it("does not remove translations from other resources", function () {
            registry.registerTranslation(createTranslation("test", "Test"));
            registry.registerTranslation(new Translation("other", "Other", { resource: "other.js", loc: { line: 1, column: 1 } }));

            registry.pruneTranslations(RESOURCE);

            assert.notOk(registry.empty, "The translations from other.js are not removed");
            assert.deepEqual(registry.toJSON(), { "other": "Other" });
        });

        it("does not remove translation if it is used by another resource", function () {
            registry.registerTranslation(createTranslation("test", "Test"));
            registry.registerTranslation(new Translation("test", "Test", { resource: "other.js", loc: { line: 1, column: 1 } }));
    ...
    function createTranslation(id, defaultText, line, column) {
        return new Translation(id, defaultText, { resource: RESOURCE, loc: { line: line || 1, column: column || 1 } });
    }
});